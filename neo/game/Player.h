...
public:
	...
	virtual void			DamageFeedback( idEntity *victim, idEntity *inflictor, int &damage, idVec3 cursorColor = idVec3( 0.8f, 0.0f, 0.0f ) );
	...
	void					SetLastHitTime( int time, idVec3 cursorColor = idVec3( 0.8f, 0.0f, 0.0f ) );
